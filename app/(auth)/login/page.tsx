...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 relative bg-gradient-to-b from-muted/30 via-background to-background">
      {/* Background Glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-foreground/5 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-md relative z-10 flex flex-col items-center">
        {/* Brand Header */}
        <div className="flex flex-col items-center gap-3 text-center mb-8">
          <KonteynerLogo size="lg" shadow className="rounded-3xl" />
          <h1 className="font-black text-4xl text-foreground tracking-widest leading-none">
            KONTEYNER
          </h1>
