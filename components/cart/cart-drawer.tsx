          ...
          <div className="flex flex-col gap-3">
            ...
            {!isLocked && (
              <Button
                ...
                className="w-full py-6 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-heading font-black text-base transition-all duration-300 shadow-lg shadow-primary/25 active:scale-98 cursor-pointer disabled:opacity-50"
              >
