...
export function ProductCard({
  ...
  const [imgSrc, setImgSrc] = React.useState(product.gorsel_url || fallbackImg);
    ...
    >
      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-muted">
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1 z-10">
          {hasPortions && (
            <Badge className="bg-primary text-primary-foreground backdrop-blur border-none text-[10px] py-0 px-2 font-black shadow-xs">
