...
import { KonteynerPreloader } from "@/components/ui/konteyner-preloader"
...
function MenuMainContent() {
  ...
  return (
    <>
      ...
      {/* Konteyner 3D Leaf Opening Entrance Preloader Animasyonu */}
      <KonteynerPreloader
      ...
      <div className="flex-1 flex flex-col w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto pb-24 min-h-screen relative bg-gradient-to-b from-muted/40 via-transparent to-muted/20">
...
export function QrMenuView({
  ...
  useEffect(() => {
    ...
    Promise.resolve().then(() => {
      ...
      const isStaff = !!localStorage.getItem("konteyner_user") || !!localStorage.getItem("yali_user");
