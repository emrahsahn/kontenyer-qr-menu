...
export const DEFAULT_WAITERS: WaiterProfile[] = [
  { id: "w1", name: "Mert", avatarColor: "bg-amber-600 text-white", pinCode: "", isActive: true, venue: "cafe", role: "barista" },
  { id: "w2", name: "Deniz", avatarColor: "bg-orange-500 text-white", pinCode: "", isActive: true, venue: "cafe", role: "barista" },
  { id: "w3", name: "Hüseyin", avatarColor: "bg-rose-500 text-white", pinCode: "", isActive: true, venue: "cafe", role: "waiter" },
  { id: "w4", name: "Zeynep", avatarColor: "bg-blue-500 text-white", pinCode: "", isActive: true, venue: "cafe", role: "waiter" }
];
